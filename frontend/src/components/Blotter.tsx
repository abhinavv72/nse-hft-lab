      ...
      <div className="blotter-grid">
        <div>
          ...
          <div className="table-grid compact">
            ...
            {orders.length === 0 && <p className="empty-state">Orders generated by your selected strategy appear here.</p>}
        ...
        <div>
          ...
          <div className="table-grid compact">
            ...
            {fills.length === 0 && <p className="empty-state">Executed simulated fills appear here.</p>}
